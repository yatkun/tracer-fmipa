    ...
    @enderror
                ...
                <div id="pertanyaan3" class="grid grid-cols-6  gap-1 md:gap-6 border-b-0 sm:border-b mb-4">
                    ...
                    <div class="col-span-6 sm:col-span-3 border-b sm:border-b-0 pb-4 sm:pb-2">
                        ...
                        <input type="text" id="p3a" name="p3a" value="{{ old('p3a') }}" placeholder="Masukkan provinsi (Contoh : Sulawesi Barat)"
                            ...
                            <input type="text" id="p3b" name="p3b" value="{{ old('p3b') }}" placeholder="Masukkan kabupaten/kota (Contoh : Majene)"
