<header class="flex items-center justify-between px-6 py-4 ">
    ...
    <div class="flex items-center gap-3">
        ...
        <div x-data="{ dropdownOpen: false }" class="relative">
            ...
            <button @click="dropdownOpen = ! dropdownOpen" class="flex">
                <img src="{{ asset('/images/foto/' . auth()->user()->foto) }}"
                    class="w-10 h-10 rounded-full  bg-cover object-cover">
            </button>
            ...
            <div x-cloak x-show="dropdownOpen" @click="dropdownOpen = false"
                class="fixed inset-x-0 mx-auto inset-0 z-10 w-full h-full">
            </div>
            ...
            <div x-cloak x-show="dropdownOpen"
                ...
                <a href="/profil"
                    ...
                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white">Ganti Password</a>
